...
Public Class TestGridSearch
    ...
    Public Sub gridSearchOptimizerWithSuccessMeasure()
        ...
        For i As Integer = 0 To OPTIMIZER_INSTANCES - 1
            ...
            ResultSaver.registerOptimizerType("GridSearch")
            ...
            Dim gridSearchOptimizer As New GridSearchOptimizer(agent)
            gridSearchOptimizer.runOptimizer(OPTIMIZER_RUNS)

            ResultSaver.saveOptimizerResultsAsFile(numberOfAgentEpisodes, gridSearchOptimizer)
        Next
    End Sub


    Public Sub gridSearchOptimizerStepsPerEpisodeMeasure()
